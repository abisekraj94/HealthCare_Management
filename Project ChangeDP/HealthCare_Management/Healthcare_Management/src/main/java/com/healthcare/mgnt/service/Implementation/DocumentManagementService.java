...
import com.healthcare.mgnt.service.IDocumentManagementService;
    ...
    public DocumentManagementResponse updateDocument(Long id, DocumentManagementRequest dto) {
        ...
        try {
            DocumentManagement entity = documentManagementRepository.findById(id)
                .orElseThrow(() -> new AppException(AppErrorCodes.DOCUMENT_NOT_FOUND, "Failed to update patient medical history"));
    ...
    public void deleteDocument(Long id) {
        ...
        try {
            if (!documentManagementRepository.existsById(id)) {
                ...
                throw new AppException(AppErrorCodes.DOCUMENT_NOT_FOUND, "Failed to update patient medical history");
            }
