...
import com.healthcare.mgnt.repository.patient.PatientIdentifierRepository;
...
public class PatientIdentifierService implements IPatientIdentifierService {
     ...
     */
    public List<PatientIdentifierResponse> getAllPatientIdentifiers(int page, int size) {
        logger.info("Fetching all patient identifiers with List");
        try {
            Pageable pageable = PageRequest.of(page, size);
            return patientIdentifierRepository.findAll(pageable)
    ...
    public void deletePatientIdentifier(Long id) {
        ...
        try {
            if (!patientIdentifierRepository.existsById(id)) {
                ...
                throw new AppException(AppErrorCodes.IDENTIFIER_NOT_FOUND);
            }
