...
-- 3. Role_Permission
CREATE TABLE apollo.role_permission (
...
CREATE TABLE apollo.role_permission_map (
...
CREATE TABLE apollo.patient_identifier (
...
CREATE TABLE apollo.patient_vital_sign (
...
CREATE TABLE apollo.patient_medical_history (
...
CREATE TABLE apollo.user_patient_assignment (
...
-- 11. Patient_Visit
CREATE TABLE apollo.patient_visit (
...
CREATE TABLE apollo.visit_patient_diagnosis (
...
CREATE TABLE apollo.visit_patient_allergy (
...
CREATE TABLE apollo.visit_patient_medication (
...
CREATE TABLE apollo.document_management (
