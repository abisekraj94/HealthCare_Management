...
import com.healthcare.mgnt.service.IPatientVisitService;
    ...
    public PatientVisitResponse updatePatientVisit(Long id, PatientVisitRequest dto) {
        ...
        try {
            PatientVisit visit = patientVisitRepository.findById(id)
                .orElseThrow(() -> new AppException(AppErrorCodes.VISIT_NOT_FOUND, "Failed to update patient medical history"));
    ...
    public void deletePatientVisit(Long id) {
        ...
        try {
            if (!patientVisitRepository.existsById(id)) {
                ...
                throw new AppException(AppErrorCodes.VISIT_NOT_FOUND, "Failed to update patient medical history");
            }
