...
import com.healthcare.mgnt.entity.user.RolePermission;
import com.healthcare.mgnt.repository.user.RolePermissionRepository;
    ...
    public void deleteRolePermission(Long id) {
        ...
        try {
            if (!rolePermissionRepository.existsById(id)) {
                ...
                throw new AppException(AppErrorCodes.PERMISSION_NOT_FOUND);
            }
